...
const lesson1231: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-6 lg:p-8 space-y-4">
      <h1 className="text-3xl font-bold mb-8">Lesson 1: What is Blockchain?</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6 overflow-y-scroll md:max-h-[650px]">
          ...
          <div className="bg-[#001123] shadow-lg rounded-lg p-6 flex flex-col justify-between">
            ...
            <p>
              Blockchain is a revolutionary digital system for recording
              information. Imagine a giant, shared spreadsheet that everyone can
              see but no one can easily change. This spreadsheet is updated
              simultaneously across thousands of computers, ensuring that{" "}
              <i className="font-extralight text-[#8ea9e9]">
                the information it contains is difficult or impossible to
                change, hack, or cheat
              </i>
              . It's like a digital ledger that's maintained by a global network
              of collaborators, rather than a single authority.
            </p>
          </div>
          ...
          {/* Text Content 2 */}
          <div className="bg-[#001123] shadow-lg rounded-lg p-6 flex flex-col justify-between">
            <h2 className="text-xl font-semibold mb-4">Blocks and Chains ⛓️</h2>
            <p>
              The name "blockchain" comes from how this technology stores data.
          ...
          <div className="bg-[#001123] shadow-lg rounded-lg p-6 flex flex-col justify-between">
            ...
            <p>
              While blockchain is the foundation for cryptocurrencies like
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6 overflow-y-scroll md:max-h-[650px]">
          ...
          <div className="bg-[#001123] shadow-lg rounded-lg p-6 flex flex-col justify-between">
            <h2 className="text-xl font-semibold mb-4">Summary 🗒️</h2>
            <p>
              Blockchain functions by grouping data into blocks and linking
              these blocks together in a specific order. When new information
              needs to be added, it's put into a new block. Once this block is
              filled with data, it's chained onto the previous block, creating a
              timeline of data. Each block contains a unique code that connects
              it to the previous block, forming an unbroken chain. This
              structure, combined with complex mathematics and computer science
...
const lesson1233: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-6 lg:p-8 space-y-4">
      <h1 className="text-3xl font-bold mb-8">Lesson 3: Types of Blockchain</h1>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6 overflow-y-scroll md:max-h-[650px]">
          {/* Public Blockchain */}
          <div className="bg-[#001123] shadow-lg rounded-lg p-6">
            <h2 className="text-xl font-semibold mb-4">Public Blockchain 🌍</h2>
            <p>
              A public blockchain is open to everyone. Think of it like the
              internet—you can access it without restrictions. Anyone can
              participate in the network, validate transactions, or create
              decentralized apps.{" "}
              <i className="font-extralight text-[#8ea9e9]">
                Bitcoin and Ethereum are examples of public blockchains
              </i>
              , where transparency and decentralization are at the core.
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6 overflow-y-scroll md:max-h-[650px]">
          ...
          <div className="bg-[#001123] shadow-lg rounded-lg p-6">
            <h2 className="text-xl font-semibold mb-4">Summary 🗒️</h2>
            <p>
              Consensus mechanisms secure blockchains without central
              authorities. PoW relies on solving puzzles, consuming more energy,
              while PoS chooses validators based on their stake, offering a more
              eco-friendly solution. Both aim to keep the blockchain safe and
              reliable.
            </p>
          </div>
        </div>
...
const lesson1235: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-6 lg:p-8 space-y-4">
      <h1 className="text-3xl font-bold mb-8">Lesson 5: Smart Contracts 📜</h1>
    ...
    <div className="max-w-7xl mx-auto p-4 md:p-6 lg:p-8 space-y-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6 overflow-y-scroll md:max-h-[650px]">
          {/* Text Content 1 */}
          <div className="bg-[#001123] shadow-lg rounded-lg p-6 flex flex-col justify-between">
            <h2 className="text-xl font-semibold mb-4">What Are Tokens? 🪙</h2>
            <p>
              Tokens are digital assets that can represent anything from money
              to property. They live on the blockchain and can be used in
              different ways, like for transactions, voting in decentralized
              organizations, or even as collectibles like NFTs.{" "}
              <i className="font-extralight text-[#8ea9e9]">
                Think of tokens like digital coupons that you can use in various
                apps
              </i>
              .
            </p>
          ...
          <div className="bg-[#001123] shadow-lg rounded-lg p-6 flex flex-col justify-between">
            ...
            <p>
              NFTs are special tokens that represent ownership of unique digital
              items, like art or music. Unlike regular tokens,{" "}
              <i className="font-extralight text-[#8ea9e9]">
                NFTs are non-fungible, meaning each one is unique and cannot be
                exchanged on a one-to-one basis like money
              </i>
              .
            </p>
          </div>
          ...
          <div className="bg-[#001123] shadow-lg rounded-lg p-6 flex flex-col justify-between">
            ...
            <p>
              Tokens are key components of the blockchain, serving as digital
              assets for transactions, services, and collectibles. Whether
              you're using utility tokens to access services or NFTs to collect
              digital art, they open up new ways to interact with digital assets
              securely.
            </p>
          </div>
        </div>
    ...
    <div className="max-w-7xl mx-auto p-4 md:p-6 lg:p-8 space-y-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6 overflow-y-scroll md:max-h-[650px]">
          {/* Text Content 1 */}
          <div className="bg-[#001123] shadow-lg rounded-lg p-6 flex flex-col justify-between">
            <h2 className="text-xl font-semibold mb-4">What is DeFi? 🏦💡</h2>
            <p>
          ...
          <div className="bg-[#001123] shadow-lg rounded-lg p-6 flex flex-col justify-between">
            ...
            <p>
              ...
              <i className="font-extralight text-[#8ea9e9]">liquidity pools</i>.
              When you add your cryptocurrency to a pool, others can borrow it,
              and you earn a share of the transaction fees.
              <i className="font-extralight text-[#8ea9e9]">
                {" "}
                It’s like putting your money in a shared piggy bank and getting
                paid whenever someone takes a coin out!
              </i>
            </p>
          </div>
          ...
          {/* Text Content 3 */}
          <div className="bg-[#001123] shadow-lg rounded-lg p-6 flex flex-col justify-between">
            <h2 className="text-xl font-semibold mb-4">DeFi Platforms 🚀🔗</h2>
            <p>
              There are several popular DeFi platforms like{" "}
              <i className="font-extralight text-[#8ea9e9]">Uniswap</i> for
              trading and <i className="font-extralight text-[#8ea9e9]">Aave</i>{" "}
              for lending.
              <i className="font-extralight text-[#8ea9e9]">
                {" "}
                Using these platforms, anyone can access financial services
                without a bank account—just a crypto wallet!
              </i>
            </p>
          </div>
          ...
          <div className="bg-[#001123] shadow-lg rounded-lg p-6 flex flex-col justify-between">
            <h2 className="text-xl font-semibold mb-4">Summary 📝</h2>
            <p>
              DeFi is revolutionizing finance by providing decentralized,
              accessible, and transparent financial services. Whether you’re
              lending, borrowing, or trading, DeFi allows anyone with an
              internet connection to participate, making finance fairer and more
              inclusive. 🌍💪
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6 overflow-y-scroll md:max-h-[650px]">
          ...
          <div className="bg-[#001123] shadow-lg rounded-lg p-6 flex flex-col justify-between">
            ...
            <p>
              Blockchain helps track products from their source to the store
              shelf. Imagine buying coffee and knowing every step it took to get
              to your cup.{" "}
              <i className="font-extralight text-[#8ea9e9]">
                It makes the process transparent and secure, ensuring no
          ...
          <div className="bg-[#001123] shadow-lg rounded-lg p-6 flex flex-col justify-between">
            ...
            <p>
              Blockchain can secure healthcare records so that patients can
              access their information anywhere, anytime.{" "}
              <i className="font-extralight text-[#8ea9e9]">
                It ensures that sensitive information is only shared with
                authorized people, while also reducing paperwork
              </i>
              .
            </p>
          </div>
          ...
          {/* Text Content 3 */}
          <div className="bg-[#001123] shadow-lg rounded-lg p-6 flex flex-col justify-between">
            <h2 className="text-xl font-semibold mb-4">Voting Systems 🗳️📊</h2>
            <p>
              Blockchain offers a transparent way to run elections, making
              results tamper-proof.{" "}
              <i className="font-extralight text-[#8ea9e9]">
                Every vote is securely recorded, ensuring that voting is fair
                and transparent
              </i>
              . This can help prevent fraud and increase public trust in
              election outcomes.
            </p>
          </div>
          ...
          <div className="bg-[#001123] shadow-lg rounded-lg p-6 flex flex-col justify-between">
            <h2 className="text-xl font-semibold mb-4">Summary 📝</h2>
            <p>
              Blockchain has wide-ranging applications beyond cryptocurrency.
              From supply chain management and healthcare records to voting
              systems, its transparency and security are valuable in many
              sectors. As we move forward, more industries will find ways to
              adopt blockchain.
            </p>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6 overflow-y-scroll md:max-h-[650px]">
          ...
          <div className="bg-[#001123] shadow-lg rounded-lg p-6 flex flex-col justify-between">
            ...
            <p>
              ...
              <i className="font-extralight text-[#8ea9e9]">trust</i>. In
              traditional systems, trust is usually built through intermediaries
              like banks or governments. But with blockchain, we can create
              trust in a decentralized way without needing a middleman. This is
              great for things like{" "}
              <i className="font-extralight text-[#8ea9e9]">
                peer-to-peer transactions, transparent voting systems, or secure
                data sharing
              </i>
              .
            </p>
          ...
          <div className="bg-[#001123] shadow-lg rounded-lg p-6 flex flex-col justify-between">
            ...
            <p>
              Blockchain provides a level of security and transparency that
              other systems often lack. Once information is recorded,{" "}
              <i className="font-extralight text-[#8ea9e9]">
                it cannot be easily altered or erased
              </i>
              . This means people can trust the system without worrying about
          ...
          <div className="bg-[#001123] shadow-lg rounded-lg p-6 flex flex-col justify-between">
            ...
            <p>
              Blockchain breaks down barriers. Whether you're sending money or
              accessing records,{" "}
              <i className="font-extralight text-[#8ea9e9]">
                you don't need to worry about country borders, business hours,
                or regulations
              </i>
              . This makes global transactions easier and faster, without the
          ...
          <div className="bg-[#001123] shadow-lg rounded-lg p-6 flex flex-col justify-between">
            <h2 className="text-xl font-semibold mb-4">Summary 📝</h2>
            <p>
              Blockchain eliminates the need for intermediaries, enhances
              security, and provides transparency. It enables global
              transactions, reducing boundaries while building trust. In short,
              it's a revolutionary tool for creating a secure and transparent
              digital world.
            </p>
          </div>
        </div>
