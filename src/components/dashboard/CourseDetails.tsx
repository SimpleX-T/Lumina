              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-4 mb-4">
                  <div className="flex items-center">
                    <CiClock2 size={20} className="text-gray-500 mr-1" />
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
              ...
              {lessons.map((lesson, index) => (
                ...
                >
                  <span className="dark:text-white">{lesson.name}</span>
                  <div className="flex items-center">
                    <CiClock2 size={16} className="text-gray-500 mr-1" />
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
              ...
              {resources.audio && (
                <div className="flex justify-between items-center py-2 border-b dark:border-gray-700">
                  <span className="dark:text-white">1 Audio File</span>
                  <div className="flex items-center">
                    <MdOutlineAudiotrack
                      size={16}
              ...
              {resources.text && (
                <div className="flex justify-between items-center py-2 border-b dark:border-gray-700">
                  <span className="dark:text-white">1 Text File</span>
                  <div className="flex items-center">
              ...
              {resources.video && (
                <div className="flex justify-between items-center py-2 border-b dark:border-gray-700">
                  <span className="dark:text-white">1 Video File</span>
                  <div className="flex items-center">
                    <FaVideo size={16} className="text-gray-500 mr-1" />
                  </div>
                </div>
              )}
              {resources.visuals && (
                <div className="flex justify-between items-center py-2 border-b dark:border-gray-700">
                  <span className="dark:text-white">Pictures</span>
                  <div className="flex items-center">
                    <ImFilePicture size={16} className="text-gray-500 mr-1" />
                  </div>
                </div>
              )}
            </div>
