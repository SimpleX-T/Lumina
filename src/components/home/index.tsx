...
const courses: Course[] = [
  ...
  {
    title: "Wallets",
    description: "Understand what cryptocurrency wallets are and how they work",
    ...
    <div className="font-poppins bg-[#0f172a] text-[#e2e8f0] w-full relative">
      ...
      <main className="max-w-[1200px] mx-auto p-4 w-full">
        <section className="flex flex-col md:flex-row items-center p-12 text-center min-h-[70vh] w-full">
          <div className="mb-8 w-full md:w-1/2 pr-4">
            <h1 className="text-4xl md:text-5xl mb-4 text-[#60a5fa] leading-snug font-bold text-center md:text-left">
              Illuminate the Path to Blockchain Mastery: Learn, Explore,
              Innovate.
            </h1>
            <p className="text-md md:text-base text-center md:text-left">
              Join Lumina and embark on a journey to master Web3 technologies,
              earn crypto, and shape the future of the internet.
            </p>
        ...
        <section id="community" className="py-12 text-center">
          ...
          <p>
            Connect with like-minded individuals, participate in hackathons, and
        ...
        <section id="about" className="py-12">
          <h2 className="font-bold text-3xl mb-4 text-[#60a5fa] text-center">
            About Lumina
          </h2>
          <p className="text-center">
            Lumina is on a mission to illuminate the path to Web3 mastery in
            Africa, one lesson at a time. We are a team of student
            developer&apos;s whose enthusiasm for the web3 space has birthed
            this idea.
          </p>
        ...
        <section className="py-12 bg-[#1e293b] rounded-lg text-center mt-12 w-full max-w-xl mx-auto px-4">
          <h2 className="font-semibold text-lg mb-4">Stay Illuminated</h2>
          <p>
      ...
      <footer className="text-center p-8 bg-[#1e293b] mt-12">
        ...
        <div className="mt-4">
          {["Privacy Policy", "Terms of Service", "Contact Us"].map(
            (link, index) => (
              <a key={index} href="#" className="text-[#fdc10d] mx-2">
                {link}
              </a>
            )
          )}
