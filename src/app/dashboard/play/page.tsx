			...
			<div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
				<div className='lg:col-span-2 space-y-6 overflow-y-scroll md:max-h-[650px] xl:max-h-[800px]'>
					...
					<div className='bg-[#001123] shadow-lg rounded-lg p-6 flex flex-col justify-between'>
						...
						<p>
							But who gets to write in this notebook 📒? In a
							blockchain ⛓️‍💥, instead of just one person being in
							charge, everyone can help maintain the notebook 📒.
							It's like if your whole class worked together to
							keep the notebook accurate, rather than just the
							teacher being in charge. This is what people mean
							when they say blockchain ⛓️‍💥 is{" "}
							<i className='font-extralight text-[#8ea9e9]'>
								"decentralized"
							</i>{" "}
