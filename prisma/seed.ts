...
const blockchainFirstQuestions = [
  ...
  {
    question: "Which of the following best describes mining in a blockchain?",
    options: [
...
const blockchainMidQuestions = [
  {
    question: "What is the purpose of a consensus mechanism in a blockchain?",
    options: [
  ...
  {
    question: "What role do governance tokens play in a blockchain ecosystem?",
    options: [
  ...
  {
    question: "Why are consensus mechanisms important for blockchain security?",
    options: [
...
const blockchainEndQuestions = [
  {
    question: "What does DeFi enable users to do without traditional banks?",
    options: [
